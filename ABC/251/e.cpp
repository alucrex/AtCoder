...
int main(){
    ...
    dp_[1] = {feed[0], 1};
    rep(i, n-2) {
        dp[0] = min(dp_[1], {dp_[0].first + feed[i], dp_[0].second});
        dp[1] = min(m_p(dp_[0].first + feed[i+1] , dp_[0].second), m_p(dp_[1].first + feed[i+1] , dp_[1].second));
    ...
    dp[0] = min(dp_[1], {dp_[0].first + feed[n-2], dp_[0].second});
    dp[1] = min(m_p(dp_[0].first + feed[n-1]*dp_[0].second , dp_[0].second), m_p(dp_[1].first + feed[n-1]*dp_[1].second , dp_[1].second));

    cout << min(dp[0], dp[1]).first << endl;
    //set_time(__end__);
