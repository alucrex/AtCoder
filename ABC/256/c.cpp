    ...
    rep(i0, y[0].size()) {
        rep(i1, y[1].size()) {
            rep(i2, y[2].size()) {
                ...
                vvv<int> cand(3, vvi(6));
                    
                    cand[0][0] = y[0][i0];
                    cand[0][1] = {y[0][i0][0], y[0][i0][2], y[0][i0][1]};
                    cand[0][2] = {y[0][i0][1], y[0][i0][0], y[0][i0][2]};
                    cand[0][3] = {y[0][i0][1], y[0][i0][2], y[0][i0][0]};
                    cand[0][4] = {y[0][i0][2], y[0][i0][0], y[0][i0][1]};
                    cand[0][5] = {y[0][i0][2], y[0][i0][1], y[0][i0][0]};

                    cand[1][0] = y[1][i1];
                    cand[1][1] = {y[1][i1][0], y[1][i1][2], y[1][i1][1]};
                    cand[1][2] = {y[1][i1][1], y[1][i1][0], y[1][i1][2]};
                    cand[1][3] = {y[1][i1][1], y[1][i1][2], y[1][i1][0]};
                    cand[1][4] = {y[1][i1][2], y[1][i1][0], y[1][i1][1]};
                    cand[1][5] = {y[1][i1][2], y[1][i1][1], y[1][i1][0]};

                    cand[2][0] = y[2][i2];
                    cand[2][1] = {y[2][i2][0], y[2][i2][2], y[2][i2][1]};
                    cand[2][2] = {y[2][i2][1], y[2][i2][0], y[2][i2][2]};
                    cand[2][3] = {y[2][i2][1], y[2][i2][2], y[2][i2][0]};
                    cand[2][4] = {y[2][i2][2], y[2][i2][0], y[2][i2][1]};
                    cand[2][5] = {y[2][i2][2], y[2][i2][1], y[2][i2][0]};
                ...
                rep(j1, 6) {
                    ...
                    rep(j2, 6) {
                        rep(j3, 6) {
                            rep(k, 3) x[k] = cand[0][j1][k] + cand[1][j2][k] + cand[2][j3][k];
                            if(x[0] == w[0] && x[1] == w[1] && x[2] == w[2]){
                                ans++;
                                flg = 1;
                            }
                            if(flg) break;
