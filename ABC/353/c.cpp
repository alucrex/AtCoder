...
int main(){
    ...
    rep(i, n) {
        ...
        auto itr = lower_bound(alst.begin()+i+1, alst.end(), MOD-a);
        ans -= MOD*(alst.end() - itr);

        auto itr2 = lower_bound(alst.begin()+i+1, alst.end(), MOD*2-a);
        ans -= MOD*(alst.end() - itr2);
